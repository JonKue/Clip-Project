...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE VITALSIGNS (id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                "bodyTemp TEXT, pulse TEXT, resRate TEXT, systolicBP TEXT, diasytolicBP TEXT)");
    }
...
//      db.openOrCreateDatabase(path, null);
    ...
    void addVitalSign(VitalSign myVitalSign) {
       ...
       values.put("bodyTemp", myVitalSign.getBodyTemperature());
       values.put("pulse", myVitalSign.getPulse());
       values.put("resRate", myVitalSign.getRespirationRate());
       values.put("systolicBP", myVitalSign.getBloodPressure()[0]);
       values.put("diasytolicBP", myVitalSign.getBloodPressure()[1]);
       // Inserting Row
...
// Getting vitals signs
   VitalSign getVitalSign(int id) {
       SQLiteDatabase db = this.getReadableDatabase();

       String selectQuery = "SELECT * FROM VITALSIGNS WHERE id = " +id;
       ...
       vitalSign.setPulse(cursor.getString(2));
       vitalSign.setRespirationRate(cursor.getString(3));
       String[] bp = {cursor.getString(4), cursor.getString(5)};
