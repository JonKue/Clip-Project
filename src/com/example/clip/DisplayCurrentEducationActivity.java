...
public class DisplayCurrentEducationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		name = (TextView) findViewById(R.id.tvDisplaySchoolName);
		type = (TextView) findViewById(R.id.tvDisplayDegree);
		prog = (TextView) findViewById(R.id.tvDisplayProgram);
		enroll = (TextView) findViewById(R.id.tvDisplayES);
		sDate = (TextView) findViewById(R.id.tvDisplayDateStarted);
		gDate = (TextView) findViewById(R.id.tvDisplayDateGrad);
		tuit = (TextView) findViewById(R.id.tvDisplayTuition);
		cour = (TextView) findViewById(R.id.tvDisplayCoursesPlan);
